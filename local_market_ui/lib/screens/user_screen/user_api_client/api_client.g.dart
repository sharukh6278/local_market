...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<JWTToken> login(Login login) async {
  ...
  @override
  Future<UserModel> register(UserModel userModel, String shopName) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'shopName': shopName};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
